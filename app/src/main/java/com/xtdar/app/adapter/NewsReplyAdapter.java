...
public class NewsReplyAdapter extends RecyclerView.Adapter<NewsReplyAdapter.DataHolder>  {

    public void setListItems(List<CommentReplyResponse.DataBean> listItems) {
        this.listItems = listItems;
    }

    private List<CommentReplyResponse.DataBean> listItems;
    ...
    public NewsReplyAdapter(Context c){
        this.context=c;
        this.layoutInflater=LayoutInflater.from(c);
        glideImageLoader=new GlideImageLoader();
    }

    public NewsReplyAdapter(List<CommentReplyResponse.DataBean> l, Context c){
        this.listItems=l;
        this.context=c;
        this.layoutInflater=LayoutInflater.from(c);
        glideImageLoader=new GlideImageLoader();
    ...
    public DataHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        else if(mFooterView != null &&viewType == TYPE_FOOTER)
        {
            ...
            View v = layoutInflater.inflate(R.layout.listitem_news_reply, parent, false);
    ...
    public void onBindViewHolder(final DataHolder holder, final int position) {
        ...
        final CommentReplyResponse.DataBean listItem = listItems.get(pos);
        if(holder instanceof DataHolder) {
            holder.nickName.setText(listItem.getNick_name());
            //holder.content.setText(listItem.getPost_date()+"sssssss");
            ...
            tvNickName.setText(listItem.getNick_name());
            //实例化一个TextView
            ...
            tvComment.setText(listItem.getReply());

                    if(listItem.getAt_nick_name()==null){
                    ...
                    else
                    {
                        ...
                        tvCommentToNickName.setText(listItem.getAt_nick_name().toString());
            ...
            holder.createdate.setText(listItem.getPost_date());
            ...
            holder.layout_reply.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    mListener.onItemClick(position,listItem.getUser_id(),listItem.getCom_id(),listItem.getNick_name());
                }
            });
        }
    ...
    public interface ItemClickListener {
        void onItemClick(int position, String userId, String itemId,String nickName);
        void onTxtThumbUpClick(int position, CommentReplyResponse.DataBean bean, TextView t);
    }
