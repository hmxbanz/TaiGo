...
public class MyVideoAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final ShowResponse.DataBean entity = (ShowResponse.DataBean) mList.get(position);
        holder.mCover.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mOnItemButtonClick.onItemClick(position, v, entity.getShow_id());
            }
        });
        ...
        String avator=XtdConst.IMGURI+entity.getHead_img();
        Glide.with(mContext).load(avator).into(holder.mCover);
        holder.btnDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mOnItemButtonClick.onButtonClick(position, v, entity.getShow_id());
            }
        });
