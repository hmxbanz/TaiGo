 ...
 * Company RongCloud
 */
public class HomeAllGameFragment extends Fragment implements RecyclerViewAdapter.ItemClickListener {
    public static HomeAllGameFragment instance = null;
    ...
    public static HomeAllGameFragment getInstance() {
        if (instance == null) {
            instance = new HomeAllGameFragment();
        }
        return instance;
    }
