...
public class HelpDetailActivity extends BaseActivity implements View.OnClickListener {
    private final String TAG=HelpDetailActivity.class.getSimpleName();
...
//        //UmengUpdateAgent.update(this);
        ...
        mPullWebView = (PullToRefreshWebView) findViewById(R.id.webview_help);//new PullToRefreshWebView(this);
        ...
        mWebView.setWebViewClient(new MyWebViewClient(HelpDetailActivity.this));
...
//        menuItem.setIcon(R.drawable.ic_home_black_24dp);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent)
    {
        ...
        else if (requestCode == this.myWebChromeClient.FILECHOOSER_RESULTCODE)
        {
            ...
            Uri result = intent == null || resultCode != HelpDetailActivity.RESULT_OK ? null : intent.getData();
