 ...
 * Company RongCloud
 */
public class HomeLearnGameFragment extends Fragment implements RecyclerViewAdapter.ItemClickListener {
    public static HomeLearnGameFragment instance = null;
    ...
    public static HomeLearnGameFragment getInstance() {
        if (instance == null) {
            instance = new HomeLearnGameFragment();
        }
        return instance;
    }
