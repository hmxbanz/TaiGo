...
public class DBManager {
    ...
    private final static String DB_NAME = "XtdData";
    ...
    private static String getDbPath () {
        String currentUserId = mContext.getSharedPreferences("config", MODE_PRIVATE).getString(XtdConst.LOGIN_USERNAME, null);
        String dbPath = mContext.getFilesDir().getAbsolutePath();
        dbPath = dbPath + File.separator + File.separator + currentUserId;
