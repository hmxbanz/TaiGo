...
//    public static String CLIENT_CHARACTERISTIC_CONFIG = "c7a7d8a5-eba8-4cc3-a5f2-53ca57921ec7";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onConnectionStateChange(BluetoothGatt gatt, int status,
            ...
            if (newState == BluetoothProfile.STATE_CONNECTED) {
                ...
                NLog.i(TAG, "Connected to GATT server.");
                // Attempts to discover services after successful connection.
                NLog.i(TAG, "Attempting to start service discovery:"
                        + mBluetoothGatt.discoverServices());

            } else if (newState == BluetoothProfile.STATE_DISCONNECTED) {
                intentAction = ACTION_GATT_DISCONNECTED;
                mConnectionState = STATE_DISCONNECTED;
                NLog.i(TAG, "Disconnected from GATT server.");
                broadcastUpdate(intentAction);
            }
        }
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status) {
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                NLog.w(TAG, "onServicesDiscovered received: " + status);
            }
        }
        ...
        public void onCharacteristicRead(BluetoothGatt gatt,
            ...
            NLog.d(TAG, "onCharacteristicRead:" +status);
            if (status == BluetoothGatt.GATT_SUCCESS) {
    ...
    public boolean connect(final String address) {
        ...
        if (mBluetoothDeviceAddress != null
                ...
                && mBluetoothGatt != null) {
            NLog.d(TAG, "Trying to use an existing mBluetoothGatt for connection.");
        ...
        NLog.d(TAG, "Trying to create a new connection.");
    ...
    public void disconnect() {
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            NLog.w(TAG, "BluetoothAdapter not initialized");
            return;
        }
    ...
    public void readCharacteristic(BluetoothGattCharacteristic characteristic) {
        NLog.d(TAG, "readCharacteristic: "+characteristic.getProperties());
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            NLog.d(TAG, "BluetoothAdapter为空");
            return;
        }
